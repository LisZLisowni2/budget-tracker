...
export default function Header() {
    ...
    if (loading) {
        return <div className="h-auto p-5 flex justify-between bg-gradient-to-r from-yellow-500 to-orange-500 shadow-xl">
            <h1 className="text-2xl md:text-3xl lg:text-5xl">BudgetTracker - Loading</h1>
    ...
    return (
        <div className="h-auto p-5 flex justify-between bg-gradient-to-r from-yellow-500 to-orange-500 shadow-xl">
            <Link to={(user) ? "/dashboard" : "/"}><h1 className="text-2xl md:text-3xl lg:text-5xl">BudgetTracker</h1></Link>
            <div className="flex items-center justify-center *:mx-3 cursor-pointer transition hover:text-gray-300">
