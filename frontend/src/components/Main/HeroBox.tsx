...
export default function HeroBox() {
    return (
        <div className="relative bg-gradient-to-r from-rose-400 to-rose-500 p-16 lg:p-32 rounded-4xl text-center max-w-3xs lg:max-w-3xl z-10 shadow-xl backdrop-blur-xl">
